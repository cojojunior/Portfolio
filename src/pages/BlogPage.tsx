...
const BlogPage = () => {
  ...
  return (
    <section className="min-h-screen px-3 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-20 bg-white">
      <div className="max-w-7xl mx-auto">
        {/* Blog Hero Section */}
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-2xl sm:text-4xl lg:text-6xl font-extrabold text-dark-navy tracking-tight mb-2 sm:mb-4">
            My Blog
          </h1>
